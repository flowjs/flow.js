...
* `200`, `201`, `202, 204`: The chunk was accepted and correct. No need to re-upload.
...
* If this request returns a `200`, `201`, `202` or `204` HTTP code, the chunks is assumed to have been completed.
