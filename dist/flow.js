(function (global, factory) {
	...
	*/
	...
	var FORCED$1 = NEGATIVE_ZERO$1 || !STRICT_METHOD$2 || !USES_TO_LENGTH$1; // `Array.prototype.lastIndexOf` method implementation
	...
	var flow = createCommonjsModule(function (module) {
	  ...
	  (function (window, document, undefined$1) {
	    ...
	    function Flow(opts) {
	       ...
	       * @type {boolean}
	       */
	      this.support = typeof File !== 'undefined' && typeof Blob !== 'undefined' && typeof FileList !== 'undefined' && (!!Blob.prototype.slice || !!Blob.prototype.webkitSlice || !!Blob.prototype.mozSlice || false) // slicing files support
	      ;
	    ...
	    function FlowFile(flowObj, file, uniqueIdentifier) {
	      ...
	      this.uniqueIdentifier = uniqueIdentifier === undefined$1 ? flowObj.generateUniqueIdentifier(file) : uniqueIdentifier;
	      /**
	       * Size of Each Chunk
	       * @type {number}
	       */
	    ...
	    FlowChunk.prototype = {
	            ...
	            while (1) {
	              switch (_context3.prev = _context3.next) {
	                case 0:
	                  ...
	                  console.warn("Chunk ".concat(this.offset, " already read. Bytes = ").concat(bytes ? bytes.size : null, ". xhr initialized = ").concat(this.xhr ? 1 : 0)); // We may want to retry (or not) to upload (but never try to read from the stream again or risk misordered chunks
	                ...
	                case 8:
	                  ...
	                  if (this.flowObj.chunkSize) {
	                    ...
	                    console.warn("Chunk ".concat(this.offset, ": returned too much data. Got ").concat(bytes.size, ". Expected not more than ").concat(this.flowObj.chunkSize, "."));
	                  }
	       ...
	       * @function
	       */
	      xhrSend: function xhrSend(bytes) {
	    ...
	    if ( module && 'object' === "object") {
	      ...
	      window.Flow = Flow; // Register as a named AMD module, since Flow can be concatenated with other
